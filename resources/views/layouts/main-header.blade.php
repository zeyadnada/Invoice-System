            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                ...
                                <div class="wd-90p">
                                    <div class="d-flex">
                                        <h5 class="mb-1 name">Petey Crruise</h5>
                                    </div>
                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                        href="{{ route('markAsReadAll') }}">تعيين قراءة الكل</a>
                                </span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 "
                                id="notifications_count"> عدد الاشعارات
                                الغير مقروئه : {{ auth()->user()->unreadNotifications->count() }} </p>
                        </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('userImage/149071.png') }}"></a>
                    <div class="dropdown-menu">
