...
class InvoicesController extends Controller
{
    ...
    {
        $customMessages = [
            'required' => 'يرجى تعبئة الحقل :attribute',
            'max' => 'يجب ألا يتجاوز الحقل :attribute :max حرفًا',
            'unique' => 'قيمة الحقل :attribute موجودة بالفعل',
            'numeric' => 'يجب أن يكون الحقل :attribute رقميًا',
            'date' => 'صيغة التاريخ في الحقل :attribute غير صحيحة',
            'image' => 'يجب أن يكون الحقل :attribute صورة',
            'mimes' => 'يجب أن يكون نوع الملف في الحقل :attribute من الأنواع: :values',
        ];
        ...
        $this->validate($request, [
            ...
            'note' => 'required',
            'pic' => 'mimes:pdf,jpeg,png,jpg,gif|max:2048',
        ], $customMessages);
        invoices::create([
